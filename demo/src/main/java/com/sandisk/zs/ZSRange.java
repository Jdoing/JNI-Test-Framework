...
/**
 * Provides the interface to ZS range queries.
 * The class supports range object creation, iteration and termination.
 * 
 */
public class ZSRange
{
    ...
    public RangeData[] getDatas(int numItems) throws ZSContainerException
    {
        ...
        RangeData[] datas = NativeZSRange.ZSGetNextRange(numItems, meta.getZSCursor());
        /*
         * Do a sallow copy datas to avoid to be overwrite; Due to Native ZSGetRangeNext used a object pool to
    ...
    {
        int resultCode = NativeZSRange.ZSGetRangeFinish(meta.getZSCursor().getCursor());
     ...
     * Set range meta.
     * @param meta
     *          range meta contains some properties for range query, such as "start key",
     *          "end key"
     */
