...
public class JTFUtils {
	...
	public static long getNameIDMap(String containerName) throws JTFException {
		if (nameIDMap.containsKey(containerName)) {
			...
			throw new JTFException("Container Name " + containerName
					+ "not found");
		}
	}

	public static void removeNameIDMap(String containerName)
			throws JTFException {
		if (nameIDMap.containsKey(containerName)) {
	...
	public static ZSContainer getContainer(long containerID)
			throws JTFException {
